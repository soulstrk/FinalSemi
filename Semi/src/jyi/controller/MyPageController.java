...
public class MyPageController extends HttpServlet {
	...
	protected void update(HttpServletRequest request, HttpServletResponse response)
		...
		MembersVo vo = new MembersVo(id, pwd, null, addr, phone, email, 0, null, 0, postnum, 0, null, null);
		MyPageDao dao = MyPageDao.getInstance();
	...
	// 적립금 목록 보이기
	protected void pointList(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		request.setCharacterEncoding("utf-8");
		String spageNum = request.getParameter("pageNum");
		int pageNum = 1;
	...
	// 고객센터 본인 게시물 불러오기
	protected void customerboardList(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		request.setCharacterEncoding("utf-8");
		String id = request.getParameter("id");
		String spageNum = request.getParameter("pageNum");
		...
		request.setAttribute("pageCount", pageCount);
		request.setAttribute("list", list);
		request.getRequestDispatcher("index.jsp?content1=mypage/myPageCustomerBoardList.jsp").forward(request,
				response);
	}
	...
	// 마이페이지 상품후기 삭제하기
	protected void reviewDelete(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		request.setCharacterEncoding("utf-8");
		String id = request.getParameter("id");
