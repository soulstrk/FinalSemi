...
<!-- <script src="js/cartSlide.js"></script> -->
</head>
	...
	<div class="col-md-2"></div>
		<div class="col-md-8">
			<div class="table-cart table-fill-prd">
				...
				<!-- //////////////장바구니 논의: 상품페이지에서 장바구니 담을 때 같은 상품명끼리 수량 맞춰 넣기 /////////// -->
				<tbody> <!-- 상품정보 담는 곳 --> 
		...
		<!-- 이미지    --><td><div class="thumb"><a href="#"><img src="pImages/${pvo.p_image }" alt="상품 섬네일" id="CartImg"/></a></div></td>
